    ...
    function getValue() {
      ...
      Object.keys(data).map((state) => {
        if (stat == state) {
          ...
          if(d1.active==0)
          {
              document.getElementById("safe").innerHTML="<h3>"+district+" is <b style='color:green;'>Safer</b></h3>";
          }
          else{
              document.getElementById("safe").innerHTML="<h3>"+district+" is <b style='color:red;'> Not Safer</b></h3>";
